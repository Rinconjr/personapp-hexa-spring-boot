...
public class PersonaControllerV1 {
	...
	public PersonaResponse eliminarPersona(@PathVariable Integer id, @PathVariable String database) throws InvalidOptionException {
	...
	public PersonaResponse persona(@PathVariable Integer id, @PathVariable String database) {
